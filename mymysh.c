    ...
    while (fgets(line, MAXLINE, stdin) != NULL) {
            ...
            if(strcmp(expanded_line[0],"pwd") == 0){  //Implementing pwd
                ...
                if(WIFEXITED(stat)){
                    ...
                    read(fd[0], recd_message, sizeof(recd_message));
                ...
                freeTokens(tokenised_line);
                  ...
                  //Child process
                  execute(expanded_line, path, envp, line);
            }
            prompt();
      }
...
void execute(char **args, char **path, char **envp, char* untokenised_line){
    ...
    if (execFound == 0){
        ...
        write(fd[1], untokenised_line , MAXLINE * sizeof(untokenised_line));
